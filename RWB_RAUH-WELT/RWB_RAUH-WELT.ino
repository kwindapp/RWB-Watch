...
void loop() {
    ...
    txtSprite.drawString(String(timeHour) + ":" + String(timeMin), 97, -2);
    ...
    kiterRWB1Sprite.pushToSprite(&background, x + 0 + x * 4, -5 + randNumber - x * 0, TFT_BLACK);
    ...
    kiterRWB9Sprite.pushToSprite(&background, x - 1222 + x * 10, 25, TFT_BLACK);//venice

    kiterRWB8Sprite.pushImage(0, 0, kiterRWB8_HEIGHT, kiterRWB8_WIDTH, kiterRWB8);
    kiterRWB8Sprite.pushToSprite(&background, x - 1290 + x * 12, -20, TFT_BLACK);//toronto
